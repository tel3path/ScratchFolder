...
* Thread model: posix
* OS: macOS Big Sur v11.7.1)
* - using g++ remotely in a non-CHERI environment on FreeBSD gcc (Debian 10.2.1-6) 10.2.1 20210110
...
int main(int argc, char *argv[])
{
    ...
    printf("Mind you, this is with the include//common.h commented out.\n");
