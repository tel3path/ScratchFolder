...
*
* This began as a straight copy of the vanilla version,
* contain only CHERI-unaware code.
* Then I add CHERI-aware functionality
...
* - Fakedb_cherryenv.c built using g++ remotely in a non-CHERI environment on FreeBSD
* - This version built using QEMU morello-purecap on bencher14
*
